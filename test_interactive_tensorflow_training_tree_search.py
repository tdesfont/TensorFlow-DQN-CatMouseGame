...
Train and Test the DQN with tree search
...
for step in range(10):
    ...
    train(model, simulation, batch_size=128, n_iterations=1, gamma=0.7,
      learning_rate=0.01, grid_size=10, tree_search=True, ts_prop=0.5, warm_restart=True)
    end_time = time.time()
